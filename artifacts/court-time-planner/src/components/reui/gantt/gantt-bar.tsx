...
function GanttBar<TData = unknown>({
  ...
  const defaultProps = {
    ...
    className: cn(
      "group/gantt-bar-group text-foreground @container relative flex w-full min-w-0 cursor-pointer touch-none items-center gap-1.5 overflow-visible rounded-sm px-1.5 py-0.5 text-start leading-normal select-none",
